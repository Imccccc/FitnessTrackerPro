...
public class MainController {
    ...
    public void searchClick(){
        ...
        ObservableList<app.model.dayAmount> amountlist = getCorrectAmountList(HomeTabController.pastCalories, DBconnector.getExerciseAmount("lhc"));
    ...
    //System.out.println("Competetor's dayAmount"+day.getAmount()+" "+day.getDate());
            ...
            areaChart.getData().addAll(myDataSeries, competorDataSeiresSeries);
